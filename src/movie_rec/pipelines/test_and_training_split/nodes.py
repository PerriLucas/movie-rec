...
def final_movie_filter(movies_titleless) :
...
def grouped_population(total_ratings) :
...
def stratify_dataset(grouped_ratings,total_ratings_in) :
    training_sample, stratified_sample = train_test_split(total_ratings_in, test_size=0.1, stratify=grouped_ratings['range'])
